...
function s.spiritorancientfilter(c,tp)
	return (c:IsCode(table.unpack(CARD_FIRE_SPIRIT_COOKIES)) or c:IsSetCard(0xc04))
...
function s.Trapoperation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(s.spiritorancientfilter,tp,LOCATION_MZONE,0,1,nil,tp)
