...
function s.ExtraAwakencon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_EXTRA,0,1,nil,10068104)
	and Cookie2.BattlePositioncon(e)
end
function s.ExtraAwakenop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local sc=Duel.SelectMatchingCard(tp,function(c) return c:IsCode(10068104) end,tp,LOCATION_EXTRA,0,1,1,nil):GetFirst()
	Duel.Overlay(sc,c)
