...
function s.arenafilter(c)
	return c:IsSetCard(0xc01) and c:IsRace(RACE_WARRIOR) and not c:IsSetCard(0xb00)
end
function s.AndCookiecost(e,tp,eg,ep,ev,re,r,rp)
	local cost1=Cookie3.manacon(e,tp,eg,ep,ev,re,r,rp,0,ATTRIBUTE_DARK,1,1)
	local cost2=Duel.GetMatchingGroupCount(s.arenafilter,tp,LOCATION_GRAVE,0,nil)>=5
...
function s.AndCookiecostoperation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.arenafilter,tp,LOCATION_GRAVE,0,5,5,nil)
	if #g>0 then
