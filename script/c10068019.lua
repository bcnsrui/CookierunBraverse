...
function s.QECookiecost(e,tp,eg,ep,ev,re,r,rp,chk)
	return e:GetHandler():IsLocation(LOCATION_EXTRA) and Duel.GetFieldGroupCount(tp,LOCATION_HAND,0)>=1
end
...
function s.QECookieeffcondition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.redlv1filter,tp,LOCATION_GRAVE,0,1,nil)
end
function s.QECookieoperation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringid(10060001,1))
	local g=Duel.SelectMatchingCard(tp,s.redlv1filter,tp,LOCATION_GRAVE,0,0,1,nil)
	if #g>0 then
