...
function s.lotusdragonfilter(c,tp)
	return c:IsCode(table.unpack(CARD_LOTUS_DRAGON)) and Cookie3.NoEmFzonefilter(c,tp)
end
function s.Stageoperation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(s.lotusdragonfilter,tp,LOCATION_MZONE,0,1,nil,tp)
